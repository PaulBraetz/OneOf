...
{
    /// <summary>
    /// Represents a discriminated union of 7 types.
    /// </summary>
    ...
    public readonly struct OneOf<T0, T1, T2, T3, T4, T5, T6> : IOneOf, IEquatable<OneOf<T0, T1, T2, T3, T4, T5, T6>>
    {
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T0 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(0, value0: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T1 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(1, value1: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T2 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(2, value2: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T3 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(3, value3: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T4 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(4, value4: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T5 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(5, value5: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6>(T6 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6>(6, value6: value);
        ...
        public override bool Equals(object obj)=>
            obj is OneOf<T0, T1, T2, T3, T4, T5, T6> o && Equals(o);
        ...
        public static bool operator ==(OneOf<T0, T1, T2, T3, T4, T5, T6> a,OneOf<T0, T1, T2, T3, T4, T5, T6> b) =>
            a.Equals(b);
        public static bool operator !=(OneOf<T0, T1, T2, T3, T4, T5, T6> a,OneOf<T0, T1, T2, T3, T4, T5, T6> b) =>
            !(a == b);
    }
