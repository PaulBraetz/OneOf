...
{
    /// <summary>
    /// Represents a discriminated union of 8 types.
    /// </summary>
    ...
    public readonly struct OneOf<T0, T1, T2, T3, T4, T5, T6, T7> : IOneOf, IEquatable<OneOf<T0, T1, T2, T3, T4, T5, T6, T7>>
    {
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T0 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(0, value0: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T1 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(1, value1: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T2 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(2, value2: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T3 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(3, value3: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T4 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(4, value4: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T5 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(5, value5: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T6 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(6, value6: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(T7 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7>(7, value7: value);
        ...
        public override bool Equals(object obj)=>
            obj is OneOf<T0, T1, T2, T3, T4, T5, T6, T7> o && Equals(o);
        ...
        public static bool operator ==(OneOf<T0, T1, T2, T3, T4, T5, T6, T7> a,OneOf<T0, T1, T2, T3, T4, T5, T6, T7> b) =>
            a.Equals(b);
        public static bool operator !=(OneOf<T0, T1, T2, T3, T4, T5, T6, T7> a,OneOf<T0, T1, T2, T3, T4, T5, T6, T7> b) =>
            !(a == b);
    }
