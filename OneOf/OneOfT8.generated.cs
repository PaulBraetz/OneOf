...
namespace OneOf
{
    ...
    public readonly struct OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IOneOf, IEquatable<OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
    {
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T0 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(0, value0: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T1 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(1, value1: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T2 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(2, value2: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T3 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(3, value3: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T4 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(4, value4: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T5 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(5, value5: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T6 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(6, value6: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T7 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(7, value7: value);
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T8 value) => new OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8>(8, value8: value);
        ...
        public override bool Equals(object obj)=>
            obj is OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> o && Equals(o);
        ...
        public static bool operator ==(OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> a,OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> b) =>
            a.Equals(b);
        public static bool operator !=(OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> a,OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> b) =>
            !(a == b);
    }
